          ...
          >
            ...
            <div className="hero-content text-center text-neutral-content">
              <div className="max-w-md">
                <h1 className="mb-5 text-5xl font-bold">Mega Events</h1>
                <p className="mb-5">
                  "Event management: Turning visions into realities, we
                  meticulously plan, coordinate, and execute every detail of
                  your event, ensuring a flawless experience for you and your
                  guests. From initial concept to post-event analysis, we're
                  dedicated to making your event unforgettable."
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="card w-96 glass">
              ...
              <div className="card-body">
                ...
                <p>
                  "Explore virtual events: Connect globally, learn locally."
                </p>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="card w-96 glass">
              ...
              <div className="card-body">
                ...
                <p>
                  "Join the fun at our virtual parties - wherever you are, it's
                  a celebration!"
                </p>
                <div className="card-actions justify-end"></div>
              </div>
            ...
            <div className="card w-96 glass">
              ...
              <div className="card-body">
                ...
                <p>
                  "Get hands-on with virtual workshops: learn, create, and
