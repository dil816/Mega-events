...
const serviceLists = [
    {id:1, title: "Discounts", des: "Have many discounts", img: "/images/home/services/icon1.png"},
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            Provide high-resolution images of your products from various angles, along with detailed descriptions including size, material, and other relevant information. This helps customers make informed purchasing decisions.
            </p>
